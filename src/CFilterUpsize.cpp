#include "CFilterUpsize.h"

CFilterUpsize::CFilterUpsize(double scale)
:m_ScaleH(scale), m_ScaleW(scale)
{}
CFilterUpsize::CFilterUpsize(double scaleH, double scaleW)
:m_ScaleH(scaleH), m_ScaleW(scaleW)
{}

void CFilterUpsize::edit(CImage & origimage) const {
...
std::uint8_t CFilterUpsize::calculatePixel(const CImage & origimage, double origH, double origW) const{
